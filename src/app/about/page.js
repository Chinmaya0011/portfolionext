  ...
  return (<>
    ...
    <div className={style.about}>
      ...
      <div className={style.content}>
        <p className={style.paragraph}>Hello, I'm [Your Name], a passionate web developer recent graduate with a keen interest in the ever-evolving world of web development.</p>
